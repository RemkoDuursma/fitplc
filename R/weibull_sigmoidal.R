...
#' @description The Weibull function, as re-parameterized by Ogle et al. (2009), which describes the relative conductivity as a function of the plant water potential. The relative conductivity is scaled to be 1 when water potential is zero. 
...
#' @param P Water potential (positive-valued MPa)
#' @param a Shape parameter, related to the slope at the inflection point as slope = -a/4
